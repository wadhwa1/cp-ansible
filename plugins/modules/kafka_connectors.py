...
def run_module():
    ...
    try:
        ...
        # print("fridayyy" + str(added_updated_messages))

        output_messages.append("Connectors added or updated: {}.".format(', '.join(added_updated_messages)))
        # print("fridayyy"+ str(output_messages))
        result['message'] = " ".join(output_messages)

        if connector_failure:
            # print("fridayyy22"+added_updated_messages)
            # print("fridayyy22"+output_messages)
            module.fail_json(msg='An error occurred while running the module friday', **result)

    except Exception as e:
        result['message'] = str(e)

        module.fail_json(msg='An error occurred while running the module' + day, **result)
